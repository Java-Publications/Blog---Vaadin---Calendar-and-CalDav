...
package junit.com.svenruppert.vaadin.calendar;
...
class CalendarViewBrowserlessTest extends BrowserlessTest {
  ...
  static void startTestbench() throws IOException {
    ...
    // CalendarView ctor at the fixture URL — no static
  ...
  void seedAuthState() {
    ...
    if (session != null) {
      ...
      // no-arg CalendarView ctor's default fallback (which used to go
      ...
      session.setAttribute(CalendarView.SESSION_KEY_CONNECTION,
  ...
  void connectionsDialogListsAllServers() throws Exception {
    ...
    com.svenruppert.vaadin.calendar.service.CalDavServerConnection live =
        com.svenruppert.vaadin.calendar.service.CalDavServerConnection.create(
            "Testbench", fixture.baseUri(), null, null);
    com.svenruppert.vaadin.calendar.service.CalDavServerConnection dead =
        com.svenruppert.vaadin.calendar.service.CalDavServerConnection.create(
