...
package com.svenruppert.vaadin.calendar.ui;

import com.svenruppert.dependencies.core.logger.HasLogger;
import com.svenruppert.vaadin.calendar.client.CalDavClient;
import com.svenruppert.vaadin.calendar.client.CalDavDiscovery;
import com.svenruppert.vaadin.calendar.client.CalDavErrors;
import com.svenruppert.vaadin.calendar.client.DiscoveredCalendar;
import com.svenruppert.vaadin.calendar.service.CalDavConnectionConfig;
import com.svenruppert.vaadin.calendar.service.CalDavProviderPreset;
import com.svenruppert.vaadin.calendar.service.CalDavServerConnection;
import com.svenruppert.vaadin.calendar.service.CalendarService;
import com.svenruppert.vaadin.calendar.service.CalendarSubscription;
...
public class CalendarView extends Composite<VerticalLayout>
  ...
  public CalendarView(CalendarStateStore stateStore) {
    this(stateStore, null, resolveInitialService(stateStore));
  }

  public CalendarView(CalendarStateStore stateStore, CalendarMessages messages) {
  ...
  CalendarView(CalendarStateStore stateStore, CalendarService service) {
    this(stateStore, null, service);
  }

  CalendarView(CalendarStateStore stateStore, CalendarMessages messages,
  ...
  private com.vaadin.flow.component.Component buildHeader() {
    ...
    root.addClassName("calendar-view__page-header");
    return root;
  }
      ...
      if (visible != null) {
        stream = stream.filter(e -> {
          ...
          java.util.Optional<URI> href =
              com.svenruppert.vaadin.calendar.mapping.EntryMapper.readHref(e);
  ...
  private static void applySubscriptionColor(Entry entry,
    ...
    java.util.Optional<URI> href =
        com.svenruppert.vaadin.calendar.mapping.EntryMapper.readHref(entry);
  ...
  private static CalendarService resolveInitialService(CalendarStateStore store) {
    return store.readConnection()
        ...
        .orElseGet(CalendarView::defaultServiceFromPreset);
  }
   ...
   * port) should construct {@code CalendarView} via the explicit
   * {@code CalendarView(CalendarStateStore, CalendarMessages,
